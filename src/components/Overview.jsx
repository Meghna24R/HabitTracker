//component that displays the list of habit name and add new habit button 
...
const Overview = () => {
  ...
  return (
    <>
      ...
      {/* Listing the habit name */}
      <ListGroup>
        {habits.map((habit, index) => (
          <ListGroup.Item key={index} className='habitList mb-1 rounded habit-container'>
            <Row>
      ...
      <Row>
        {/* Displaying new habit button */}
        <Col className='d-flex justify-content-end'>
          <Button
            type='button'
            className='newBtn mt-3 mobile'
